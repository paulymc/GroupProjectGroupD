...
public class NewRent extends JFrame implements ActionListener {
	...
	//	ResultP.setLayout(new GridLayout(2,0));
		...
		//Search text area
		//JTextField search = new JTextField("Input Search");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(Event == searchByTitle)
		{
			...
			//needs work
			String dvdTitle = search.getText();

			//ResultSet cursor = St_search.DisplayStock();
			
			if(dvdTitle.length() < 1)
			{
		...
		if(Event == confirm)
		{
		 ...
		 JOptionPane.showMessageDialog(this, "Rent completed successfully");
